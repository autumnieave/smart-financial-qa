...
- 答案质量回归：top-5 冒烟 10 题 100%（500/500）→ top-5 全量 108 题 99.9%（3506/3508，2 例见 docs/评估报告/答案质量回归报告.md）→ **回退 top-10 后全量 108 题恢复 100%（已确认：108/108、3879/3879 = 100%，证据 `docs/评估报告/答案质量回归报告.md` + `训练结果数据/golden_answer_full_top10.log`，2026-08-31）**。
