...
# 数据链路目录（正式数据：附件2 财务报告）
PDF_DIRS = [
    ("sz", "data_corpus/全部数据/正式数据/附件2：财务报告/reports-深交所"),
    ("sh", "data_corpus/全部数据/正式数据/附件2：财务报告/reports-上交所"),
]
# 字段定义表（正式数据：附件3）
FIELDS_XLSX = "data_corpus/全部数据/正式数据/附件3：数据库-表名及字段说明.xlsx"
